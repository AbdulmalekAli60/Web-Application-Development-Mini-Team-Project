...
<body>
    ...
    <h2 style="text-align: center; color: #ccc;"> بطارية ايفون 14 برو ماكس</h2>
    ...
    <div class="dropdown">
        ...
        <div class="dropdown_menu">
            ...
            <a href="https://www.ifixit.com/products/iphone-14-pro-max-battery" target="_blank">بطارية ايفون 14 برو ماكس</a>
               ...
               <div class="card">
                ...
                <div class="text">
                 <span class="steps">الخطوة 10</span>
                    <ul class="list">
                        <li>قم بإزالة الشاشة</li>
                        <li>اتخاذ الخطوات إلى الوراء</li>
                    </ul>
                </div>
            </div>
             <!-- Step 11 -->
             <div class="card">
                <img src="https://guide-images.cdn.ifixit.com/igi/CYLtCMRFp3DlYxVK.medium" alt="">
                <div class="text">
                 <span class="steps">الخطوة 11</span>
                    <ul class="list">
                        <li>فك مسامير مكبر الصوت</li>
                        <li>استخدم مفك المسامير لإزالة المسامير الأربعة التي يبلغ طولها 1.5 مم والتي تثبت مكبر الصوت:</li>
                        <li>ثلاثة مسامير أصغر رأسا</li>
                        <li>مسمار واحد أكبر</li>
                    </ul>
                </div>
            </div>
              <!-- Step 12 -->
              <div class="card">
                <img src="https://guide-images.cdn.ifixit.com/igi/EKQZXTaWrwfjLxii.medium" alt="">
                <div class="text">
                 <span class="steps">الخطوة 12</span>
                    <ul class="list">
                        <li>قم بإزالة مكبر الصوت</li>
                        <li>استخدم زوجا من الملاقط للاستيلاء على مكبر الصوت.</li>
                        <li>قم بإزالة مكبر الصوت لفصله عن الشريط اللاصق الذي يؤدي إلى محرك الاهتزاز.</li>
                    </ul>
                </div>
            </div>
            <!-- Step 13 -->
            <div class="card">
                <img src="https://guide-images.cdn.ifixit.com/igi/vEPeYtYKshc3hRFL.medium" alt="">
                <div class="text">
                 <span class="steps">الخطوة 13</span>
                    <ul class="list">
                        <li>قم بإزالة مكبر الصوت</li>
                        <li>استخدم زوجا من الملاقط للاستيلاء على مكبر الصوت.</li>
                        <li>قم بإزالة مكبر الصوت لفصله عن الشريط اللاصق الذي يؤدي إلى محرك الاهتزاز.</li>
             ...
             <!-- Step 14 -->
             <div class="card">
                <img src="https://guide-images.cdn.ifixit.com/igi/V6KAj35CSYFAyQYd.medium" alt="">
                <div class="text">
                 <span class="steps">الخطوة 14</span>
                    <ul class="list">
                        <li>أمسك بالشريط السحب الأول بأصابعك أو لفها حول الملقاط  واسحبها ببطء بعيدا عن البطارية ، باتجاه الجزء السفلي من جهاز الايفون.</li>
                        <li>اسحب بقوة كافية للحفاظ  على الشريط  مشدود قليلا، لكن لا تشد بقوة . استمر في ذلك حتى يتمدد ويفك الالتصاق من تحت البطارية.</li>
                        <li>لا تضغط لأسفل على البطارية. أمسك جهاز الايفون بإحكام من جانبيه.</li>
                        <li>حافظ على الشريط مشدود . حاول أن تسحب بالتساوي على الشريط بأكمله ، بدلا من السحب بشكل أساسي في المنتصف أو على جانب واحد.</li>
                        <li>إذا انفصل الشريط اللاصق ، فحاول استعادته باستخدام أصابعك أو ملاقط حادة ، واستمر في السحب - لكن لا تسحب من تحت الشريط تحت البطارية.</li>
                        <li>إذا انفصل أي من الشرائط اللاصقة أسفل البطارية ولا يمكن استردادها ، فحاول إزالة الشرائط الأخرى ، ثم تابع </li>
                        <li>إذا كنت لا تزال تواجه مشكلة في إزالة البطارية ، فضع بضع قطرات من كحول الأيزوبروبيل عالي التركيز (90٪ أو أعلى) تحت حافة البطارية في منطقة الشريط (الشريطات) اللاصقة المكسورة.</li>
                    </ul>
                </div>
            </div>
               <!-- Step 15 -->
               <div class="card">
                <img src="https://guide-images.cdn.ifixit.com/igi/2Z63WQvxDfoQEFMl.medium" alt="">
                <div class="text">
                 <span class="steps">الخطوة 15</span>
                    <ul class="list">
